                ...
                <ul class="list-none">
                  ...
                  <li>
                    <article class="hover:bg-gray-200 dark:hover:bg-indigo-800 transition duration-350 ease-in-out">
                          ...
                          <div class="flex items-center">
                            ...
                            <div class="ml-3">
                              <p class="text-base leading-6 font-medium text-gray-900 dark:text-white">
                                ...
                                <?php
                                if (isset($_SESSION['Email']) && $_SESSION['Email'] === $fetch['iUserEmail']) {
                                  echo $_SESSION['ifirstname'] . ' ' . $_SESSION['ilastname'];
                                  $isCurrentUserPost = true;
                                } else {
                                  echo $row['iUserEmail']; // Display username for other users' posts
                      ...
                      <div class="pl-16">
                        <p class="text-base width-auto font-medium text-gray-900 dark:text-white flex-shrink mx-2">
                        ...
                        <div id="uploaded_image" class="md:flex-shrink pr-6 pt-3">
                          <div class="bg-cover bg-no-repeat bg-center rounded-lg w-full h-64" style="
                            ...
                            ">
                            <img class="opacity-0 w-full h-full" src="<?php echo $fetch['image_post'] ?>" alt="" />
                          </div>
                        </div>
